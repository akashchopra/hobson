// Update hobson-instance-renderer to use iframe-based isolation
const item = await kernel.storage.get('99999999-1111-0000-0000-000000000000');

item.content.code = `// hobson-instance renderer - iframe-based isolation
...
console.log('Updated hobson-instance-renderer to iframe-based implementation');
