// REPL Script: Create field_editor_itemref
// Field editor for item references (GUIDs) with search modal

const fieldEditorItemref = {
  id: crypto.randomUUID(),
  name: "field_editor_itemref",
...
await kernel.storage.set(fieldEditorItemref, kernel);
console.log("Created field_editor_itemref:", fieldEditorItemref.id);
console.log("");
console.log("This field editor provides item reference selection via search modal.");
console.log("");
console.log("Usage in ui_hints:");
console.log("  type: { editor: 'itemref', label: 'Type' }");
console.log("");
console.log("Options:");
console.log("  - modalTitle: Custom modal title (default: 'Select Item')");
console.log("  - searchPlaceholder: Custom search placeholder");
console.log("  - targetContainer: Limit search to specific container");
console.log("");
console.log("Next: Update atom_form_editor ui_hints to use this editor for type field");
